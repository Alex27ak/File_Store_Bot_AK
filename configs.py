...
class Config(object):
	...
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://Alex1206:Alex1206@cluster0.jkellzr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001627812746")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002116821985")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://telegra.ph/file/4bb5f6bb280337b73335c.jpg")
  ...
  # LP_CUSTOM_TEMPLATE= os.environ.get("LP_CUSTOM_TEMPLATE","{file_name} - example \n\n Please Upadate this template acording to you @LazyDeveloperr ")
	...
	AUTO_DELETE_TIME = int(os.environ.get('AUTO_DELETE_TIME', 2))
